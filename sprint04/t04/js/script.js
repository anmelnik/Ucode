...
function changeStatus(elem) {
    ...
    if (name === 'human') {
        ...
        Object.assign(Werewolft.prototype, test)
        head.src = magician._getPortrait();
        createText(magician)
        let ok = document.querySelector(".descriptionHeroes");
        ok.insertAdjacentHTML('afterbegin', `<button onclick="wolf()">howl</button><br>\
        <button onclick="transformWolf()">Treaform</button> <br>`)
...
function Werewolft(name, age, species, job) {
...
let werewolf = new Werewolft('Rachel', 18, 'werewolf', 'teacher')
